...
import { AirdropNavBarProps } from '../../types'
import Notification from '../Notification'
import ModeSwitch from '@/app/ModeSwitcher'

const NavBar: React.FC<AirdropNavBarProps> = ({ account, handleAccount }) => {
    ...
    <nav className="w-full flex flex-row p-3 px-10 justify-between max-[426px]:px-2">
      ...
      <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box bg-whiteRabbit dark:bg-base-200">
          <h3 className="font-bold text-lg text-black dark:text-white">Aurora Lite!</h3>

    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-bulb-grey dark:from-cyan-500 via-transparent dark:via-transparent to-transparent dark:to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-bulb-grey dark:to-cyan-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <div className="absolute inset-auto z-50 h-36 w-[30rem] -translate-y-1/2 rounded-full bg-bulb-grey dark:bg-cyan-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-bulb-grey dark:bg-cyan-400 "
        ></motion.div>
